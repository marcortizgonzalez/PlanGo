...
namespace odb
{
        ...
        std::size_t d)
  {
    ...
    if (t[0UL])
    {
      i.hotel_value.capacity (i.hotel_size);
      grew = true;
    }
        ...
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = i.hotel_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.hotel_value.capacity ());
    b[n].length = &i.hotel_size;
    b[n].is_null = &i.hotel_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.hotel_value.capacity ());
      mysql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i.hotel_null = is_null;
      i.hotel_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.hotel_value.capacity ());
    }
